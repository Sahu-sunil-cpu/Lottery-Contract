...
pub mod token_lottery {
    ...
    pub fn buy_ticket(ctx: Context<BuyTicket>) -> Result<()> {
        ...
        let ticket_name =
            NAME.to_owned() + ctx.accounts.lottery_token.ticket_num.to_string().as_str();
...
pub struct InitializeLottery<'info> {
    ...
    pub collection_token_account: Box<InterfaceAccount<'info, TokenAccount>>, // creating associated token account
