...
export const COUNTER_PROGRAM_ID = new PublicKey(LotteryIDL.address)

// This is a helper function to get the Counter Anchor program.
export function getVestingProgram(provider: AnchorProvider, address?: PublicKey): Program<TokenLottery> {
